                ...
                <div className={styles.block}>
                    ...
                    <div>
                                ...
                                <Text
                                    size={'M'}
                                >
                                        The position points are calculated based on the rank of the player in the leaderboard. The higher the rank, the more position points the player gets. The position points are calculated using this formula:
                                </Text>
                    </div>
                        <div className={styles.expression}>
                                <Text align={'center'} containerWidth={'full'} size={'L'} nowrap>
                                        position_points = base_position_points × (1 — ((player_position — 1) / numbers_of_scores)
                                </Text>
                        </div>
                        <Text size={'M'}>
                                Where:
                                <ul>
                                        ...
                                        <li>
                                                <Text size={'M'}>
                                                        {'"player_position"'} is the rank of the player in the leaderboard, from 1 to 100.
                                                </Text>
                                        </li>
                                        <li>
                                                <Text size={'M'}>
                                                        {'"number_of_scores"'} is the total number of scores in the leaderboard, which is 100.
                                                </Text>
                                        </li>
                                </ul>
                        </Text>
                        ...
                        <div>
                                ...
                                <Text size={'M'}>
                                        The score points are calculated based on the score of the player in the leaderboard. The score is the time of the player in milliseconds in each track. The lower the score, the better. The score points are calculated using this formula:
                                </Text>
                        </div>
                        <div className={styles.expression}>
                                <Text align={'center'} containerWidth={'full'} size={'L'} nowrap>
                                        score_points = base_score_points — (base_score_points × ((best_score — playerScore) / (best_score — worst_score))⁴
                                </Text>
                        </div>
                        <Text size={'M'}>
                                Where:
                                <ul>
                                        ...
                                        <li>
                                                <Text size={'M'}>
                                                        {'"best_score"'} is the lowest time in the leaderboard, which is also the best score.
                                                </Text>
                                        </li>
                                        <li>
                                                <Text size={'M'}>
                                                        {'"worst_score"'} is the highest time in the leaderboard, which is also the worst score.
                                                </Text>
                                        </li>
                                        <li>
                                                <Text size={'M'}>
                                        ...
                                        <li>
                                                <Text size={'M'}>
                                                        {'"(x)⁴"'} is rounded to the nearest decimal number with 4 digits precision.
                                                </Text>
                                        </li>
                                </ul>
                        </Text>
                        ...
                        <div>
                                ...
                                <Text size={'M'}>
                                        The total points are calculated by adding up the position points and the score points. The total points are used to rank the players in the leaderboard, with higher total points meaning higher rank. The total points are calculated using this formula:
                                </Text>
                        </div>
                        <div className={styles.expression}>
                                <Text align={'center'} containerWidth={'full'} size={'L'} nowrap>
